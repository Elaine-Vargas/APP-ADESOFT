...
exports.generateFacturaPDFImproved = exports.generateFacturaTransaccionIN = exports.getFacturaData = exports.generateFacturaPDF = void 0;
...
exports.generateFacturaPDF = generateFacturaPDF;
...
const generateFacturaPDFImproved = async (req, res) => {
    const { id } = req.params;
    try {
        // Get order with all related data
        const orden = await prisma.orden.findUnique({
...
exports.generateFacturaPDFImproved = generateFacturaPDFImproved;
