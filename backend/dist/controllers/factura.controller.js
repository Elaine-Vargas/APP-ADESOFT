...
exports.generateFacturaPDFWithSize = exports.generateFacturaPDF = exports.generateFacturaTransaccionIN = exports.getFacturaData = void 0;
...
const generateFacturaPDFWithSize = async (req, res) => {
    ...
    try {
        ...
        const truncateTextToLines = (text, maxWidth, fontSize, maxLines = 2) => {
